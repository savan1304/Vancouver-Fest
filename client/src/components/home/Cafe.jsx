...
// //     //     try {
// //     //         const response = await fetch(`http://localhost:8000/api/cafe/${id}/like`, {
// //     //             method: 'POST',
// //     //             headers: {
// //     //                 'Content-Type': 'application/json',
// //     //             },
// //     //         });
// //     //         if (!response.ok) {
// //     //             throw new Error('Failed to like cafe');
// //     //         }
...
// //                     alert('You have already liked this cafe');
// //                 } else {
// //                     throw new Error('Failed to like cafe');
// //                 }
// //             } else {
...
// //                     <p className="cafe-data2"><i className="fas fa-map-marker-alt"></i> {cafe.address}</p>
// //                     <p className="cafe-data2">{cafe.priceRange}</p>
// //                     <p className="cafe-data2"><i className="fas fa-thumbs-up"></i> {cafe.likes} Likes</p>
